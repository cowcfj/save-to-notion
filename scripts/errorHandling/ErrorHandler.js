...
class ErrorHandler {
  ...
  static isRetryableError(error) {
    ...
    const isServerError =
      status >= HttpStatusRanges.SERVER_ERROR_MIN && status < HttpStatusRanges.SERVER_ERROR_MAX;
  ...
  static wrap(fn, options = {}) {
    ...
    return function (...args) {
      return ErrorHandler.withFallback(() => fn.apply(this, args), fallback, context, {
        enableLogging,
      });
    };
  }
  ...
  static wrapAsync(asyncFn, retryOptions = {}) {
    return function (...args) {
      return ErrorHandler.withRetry(() => asyncFn.apply(this, args), retryOptions);
    };
  }
}
