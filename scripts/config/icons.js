...
export const UI_ICONS = {
  ...
  // 斷開連接 (Unlink)
  UNLINK:
    '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m18.84 12.25 1.72-1.71h-.02a5.004 5.004 0 0 0-.12-7.07 5.006 5.006 0 0 0-6.95 0l-1.6 1.6"/><path d="M8.11 12.5 6.8 13.81a5.002 5.002 0 0 0-.13 7.07 5.002 5.002 0 0 0 6.96 0l1.6-1.6"/><line x1="12" y1="12" x2="16" y2="8"/><line x1="8" y1="16" x2="12" y2="12"/></svg>',
...
export function injectIcons() {
  ...
  const verifySymbols = () => {
    try {
      const defsEl = document.querySelector('#svg-sprite-definitions defs');
      if (!defsEl) {
