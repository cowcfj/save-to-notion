...
export const UI_ICONS = Object.freeze({
  ...
  // --- Brand icons (filled, single-color via currentColor) ---
  GITHUB:
  ...
  THREADS:
    '<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.509C2.35 18.44 1.5 15.586 1.472 12.01v-.017c.03-3.579.879-6.43 2.525-8.482C5.845 1.205 8.6.024 12.181 0h.014c2.746.02 5.043.725 6.826 2.098 1.677 1.29 2.858 3.13 3.509 5.467l-2.04.569c-1.104-3.96-3.898-5.984-8.304-6.015-2.91.022-5.11.936-6.54 2.717C4.307 6.504 3.616 8.914 3.589 12c.027 3.086.718 5.496 2.057 7.164 1.43 1.783 3.631 2.698 6.54 2.717 2.623-.02 4.358-.631 5.8-2.045 1.647-1.613 1.618-3.593 1.09-4.798-.31-.71-.873-1.3-1.634-1.75-.192 1.352-.622 2.446-1.284 3.272-.886 1.102-2.14 1.704-3.73 1.79-1.202.065-2.361-.218-3.259-.801-1.063-.689-1.685-1.74-1.752-2.96-.065-1.187.408-2.302 1.332-3.14.906-.824 2.194-1.329 3.628-1.423l.065-.003c.924-.044 1.772.07 2.522.338.02-.468.002-.93-.057-1.378l2.1-.27c.106.82.13 1.686.065 2.582 1.122.764 1.96 1.725 2.425 2.792.736 1.693.796 4.46-1.37 6.583-1.829 1.793-4.048 2.58-7.18 2.604zm-1.248-7.672c-.104.007-.207.015-.312.03-1.074.07-1.878.395-2.39.966-.39.433-.554.93-.528 1.395.027.503.298 1.013.805 1.34.564.364 1.263.517 1.968.483 1.004-.054 1.76-.434 2.314-1.122.418-.52.72-1.2.888-2.018-.787-.31-1.694-.482-2.744-.482z"/></svg>',
  PATREON:
    '<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><circle cx="15.5" cy="8.5" r="6.5"/><rect x="2" y="2" width="3" height="20"/></svg>',
  BUY_ME_A_COFFEE:
    '<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M4.645 7.472c2.1.53 4.779.8 7.588.8 2.809 0 5.488-.27 7.588-.8.377-.095.67-.345.837-.663L22 4.42c.199-.47-.11-.945-.605-.945H2.605c-.496 0-.805.474-.606.944l1.342 2.39c.166.317.46.567.837.662zm-.069 1.613c-.14.234-.227.505-.227.795v8.693c0 .733.416 1.376 1.03 1.72l5.846 3.252c.282.157.6.239.923.239h-.002c.323 0 .641-.082.923-.24l5.846-3.25c.614-.345 1.03-.988 1.03-1.72V9.88c0-.29-.088-.562-.227-.795-2.146.506-4.87.768-7.725.768-2.855 0-5.579-.262-7.725-.768z"/></svg>',
});
