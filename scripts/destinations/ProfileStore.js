...
export const DEFAULT_PROFILE_NAME = BACKGROUND_MESSAGES.DESTINATION_PROFILE.DEFAULT_PROFILE_NAME;
...
export const DESTINATION_PROFILE_ERRORS = {
  NOT_FOUND: '找不到目的地設定檔',
  LIMIT_REACHED: BACKGROUND_MESSAGES.DESTINATION_PROFILE.CREATE_LIMIT_REACHED,
