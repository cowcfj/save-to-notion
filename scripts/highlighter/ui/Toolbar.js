...
export class Toolbar {
    ...
    bindActionButtons() {
        ...
        const manageBtn = this.container.querySelector(
            '#manage-highlights-v2'
        );
        ...
        this.selectionHandler = (event) => {
            ...
            setTimeout(() => {
                ...
                try {
                    ...
                    const id = this.manager.addHighlight(
                        range,
                        this.manager.currentColor
                    );
    ...
    updateHighlightCount() {
        const countSpan = this.container.querySelector(
            '#highlight-count-v2'
        );
        if (countSpan) {
