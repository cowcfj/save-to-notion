...
# Notion Smart Clipper v2.8.0 打包腳本
# 此腳本會創建適合發布的 ZIP 檔案
...
cp RELEASE_NOTES_v2.7.1.md $BUILD_DIR/$PACKAGE_NAME/
cp UI_IMPROVEMENT_v2.7.2.md $BUILD_DIR/$PACKAGE_NAME/
cp RELEASE_NOTES_v2.8.0.md $BUILD_DIR/$PACKAGE_NAME/
