...
describe('HighlightList', () => {
    ...
    const mockHighlights = [
        ...
        { id: '2', text: '這是第二段標註文字，內容比較長需要截斷處理以確保不會破壞版面', color: 'green' },
    ...
    describe('列表渲染', () => {
        test('應該渲染所有標註項目', () => {
            ...
            const items = container.querySelectorAll('.delete-highlight-btn-v2');
        ...
        test('應該截斷過長的文本', () => {
            ...
            const longHighlights = [
                { id: '1', text: '這是一個非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常長的標註文字內容', color: 'yellow' }
            ];
        ...
        test('應該為每個項目設置正確的 data-highlight-id', () => {
            ...
            const secondBtn = container.querySelector(
                '[data-highlight-id="2"]'
            );
    ...
    describe('刪除功能', () => {
        ...
        test('應該為每個項目綁定獨立的刪除處理函數', () => {
            ...
            const buttons = container.querySelectorAll('.delete-highlight-btn-v2');
            buttons[0].click();
            buttons[1].click();
            buttons[2].click();
