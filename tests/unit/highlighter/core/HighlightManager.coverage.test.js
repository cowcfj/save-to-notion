...
jest.mock('../../../../scripts/highlighter/core/Range.js', () => ({
    serializeRange: jest.fn(() => ({ startContainerPath: [], startOffset: 0, endContainerPath: [], endOffset: 0, text: 'mock' })),
            ...
            expect(window.StorageUtil.saveHighlights).toHaveBeenCalledWith(
                ...
                expect.objectContaining({
                    highlights: expect.arrayContaining([
                        expect.objectContaining({ text: 'Stor' })
                    ])
                })
            );
        });
                ...
                loadHighlights: jest.fn().mockResolvedValue([
                    {
                        ...
                        text: 'Restore',
                        color: 'yellow',
                        rangeInfo: { startContainerPath: [], startOffset: 0, endContainerPath: [], endOffset: 7 }
                    }
                ]),
