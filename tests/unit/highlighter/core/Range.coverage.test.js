...
import { serializeRange, deserializeRange, restoreRangeWithRetry, findRangeByTextContent, validateRange } from '../../../../scripts/highlighter/core/Range.js';
...
describe('Range Module Coverage Tests', () => {
    ...
    describe('serializeRange', () => {
        test('should serialize range correctly', () => {
            ...
            pathUtils.getNodePath.mockReturnValueOnce([{ type: 'element', tag: 'div', index: 0 }])
