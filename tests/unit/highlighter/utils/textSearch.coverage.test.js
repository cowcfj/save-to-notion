...
import { findTextInPage, findTextWithTreeWalker, findTextFuzzy } from '../../../../scripts/highlighter/utils/textSearch.js';
...
describe('TextSearch Utils Coverage Tests', () => {
    ...
    describe('findTextInPage', () => {
        ...
        test('should clean text before searching', () => {
            ...
            expect(window.find).toHaveBeenCalledWith('Hello World', false, false, false, false, true, false);
        });
