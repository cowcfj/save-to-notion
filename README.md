# Notion Smart Clipper v2.5.0

一個智能的 Chrome 擴展，用於將網頁內容保存到 Notion，**v2.5.0 全新升級**：採用原生 CSS Highlight API，支持完美的跨元素標註，無痛自動遷移！

## ✨ 主要功能

### 🆕 新一代標註系統 (v2.5.0)
- **CSS Custom Highlight API**：使用瀏覽器原生標註功能
...
### 🔧 使用技巧
#### 標記功能（v2.5.0 已大幅簡化！）
1. **直接標註**：選擇任意文本，右鍵「標註文字」即可
2. **跨元素選擇**：可以直接選擇跨越多個段落、列表項的文本
3. **無需擔心網頁結構**：新版標註不修改網頁，完全穩定
