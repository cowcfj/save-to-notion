...
description: Apply when user explicitly requests code refactoring, improvement, cleanup, or asks how to reduce code smells. Do NOT apply during feature development, bug fixes, or when user is prototyping.
---
