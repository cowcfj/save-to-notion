...
description: Apply this rule when the user asks to write, generate, review, or improve test code, including unit tests, integration tests, or test coverage analysis.
---
